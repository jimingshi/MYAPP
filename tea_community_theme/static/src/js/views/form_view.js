odoo.define('tea_community_theme.FormView', function (require) {
    "use strict";

    var config = require('web.config');
    var FormRenderingEngineMobile = require('tea_community_theme.FormRenderingEngineMobile');
...
odoo.define('tea_community_theme.FormRenderingEngine', function (require) {
    "use strict";
...
odoo.define('tea_community_theme.FormRenderingEngineMobile', function (require) {
    "use strict";
